function [ Jtrue ] = negLLfxn( phat, mudata, vardata, N, t, N0, V0 )
...
var_in_mean =  @(p)(1/N).*(V_fxn(p, t, N0, V0)) + (0.01./mudata).^2; % vertical
var_in_var = @(p)(1/N).*(V4_fxn_ODE(p,N0, V0, t)-(((N-3)./(N-1)).*(V_fxn(p, t, N0, V0).^2))) + (0.01./vardata).^2;
