...
hold on
plot(t,modelfun_mu4(p4), 'LineWidth',2)
plot(t, modelfun_mu4(pbxform4(phatbest_J4)), 'LineWidth',2)
legend('data', 'true params', 'fit params')
...
true(:,7) = J7_4(pfxform4(p4));
guess(:,7) = J7_4(pfxform4(theta4));
fit(:,7) = J7_4(phatbest_J4);
...
fit(:,7) = var_in_var(params_best_J4);
